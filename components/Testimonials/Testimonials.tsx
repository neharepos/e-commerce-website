        ...
        <div className='py-10 mb-10'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-75'>
                ...
                <div className='text-center mb-10 max-w-150'>
                    <p data-aos="fade-up" className='text-sm text-orange-500'>What our customers are saying</p>
                ...
                <div data-aos="zoom-in">
                    <Slider {...settings}>
                        ...
                        py-8 px-6 mx-4 rounded-xl dark:bg-gray-800
                         bg-orange-400 opacity-90 relative'
                            >
                                <div className='mb-4'>
                                    <img src={data.img}
                                        alt=""
                                ...
                                <p className='text-black opacity-80 text-9xl
