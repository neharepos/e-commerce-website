...
import BannerImg from "../../public/women/women6.webp"
...
const Banner = () => {
  return (
    <div className='min-h-137.5 flex justify-center
        ...
        <div className='grid grid-cols-1
          ...
          <div data-aos="zoom-in">
            <img
              src={BannerImg.src}
              alt=""
              className='max-w-100 h-87.5 w-full 
          ...
          justify-center gap-6 sm:pt-0'>
            ...
            tracking-wide leading-5'>
              Lorem ipsum dolor sit, amet consectetur
               adipisicing elit. Ipsum rem nam error, 
               facere aliquid quam.
            </p>
